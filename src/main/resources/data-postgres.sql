...
insert into pacijent (ime, prezime, username, password, email, adresa, grad, drzava, broj_tel, lbo, aktiviran_nalog, uloga) values ('ime', 'prezime', 'pacijent', 'pacijent', 'mail', 'adr', 'grad', 'drzava', '021', 123, true, 'Pacijent');
